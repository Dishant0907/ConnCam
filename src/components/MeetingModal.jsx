        ...
        <Dialog open={isOpen} onOpenChange={onClose}>
            ...
            <DialogContent className="flex w-full max-w-[520px] flex-col gap-6 border-none bg-[#1C1F2E] px-6 py-9 text-white">
                <div className='flex flex-col gap-6'>
                    ...
                    {children}
                    <Button className={"bg-blue-500 focus-visible:ring-0 focus-visible:ring-offset-0"} onClick={handleClick}>{buttonIcon && (<Image src={buttonIcon} alt="button-icon" width={13} height={13}/>)} &nbsp;{buttonText || 'Schedule Meeting'}</Button>
                </div>
